...
const validateUploadedDataPrompt = ai.definePrompt({
  ...
  system: `You are an AI assistant that validates user-provided financial data to identify anomalies or inconsistencies. An anomaly is an entry that is not within a normal range. Return a list of anomalies found, being specific about why each entry is an anomaly. If there are no anomalies, return an empty array.`,
